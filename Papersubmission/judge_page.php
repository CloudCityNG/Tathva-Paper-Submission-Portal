...
function get_paper()
{
    ...
    while ($get = mysqli_fetch_assoc($result))
    {
        ...
        echo '<tr><td>'.$i.'</td><td><a href='.$Link.' target=Viewer>'.$get["Upload"].'</a></td><td><form name="judged" value="judged" method="POST"><input type="textbox" value=0 name="marks"><input type="submit" value='.$i.'.judged name="judged"></form></td></tr>';
        $i++;
    }
    echo "</table>";
    return set_judged();
